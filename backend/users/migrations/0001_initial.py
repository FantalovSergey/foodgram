    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Уберите галочку, чтобы заблокировать пользователя.', verbose_name='Действующий')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ('-id',),
                'constraints': [models.UniqueConstraint(fields=('author', 'follower'), name='unique_subscription', violation_error_message='Такая подписка уже существует.'), models.CheckConstraint(condition=models.Q(('author', models.F('follower')), _negated=True), name='author_is_not_follower', violation_error_message='Поля "author" и "follower" должны различаться.')],
            },
        ),
    ]
